...
const TutorialPanel = ({ tutorial, type }: { tutorial: any; type: string }) => (
	<div className="w-[412px] rounded-xl border-[1px] border-neutral-disabled bg-white p-4 shadow-sm">
...
const EmptyState = ({ type, onButtonClick }: EmptyStateProps) => {
	...
	if (!config) return null // or a fallback UI
