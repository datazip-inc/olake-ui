...
type DriverConfig struct {
	...
	Config  JSONConfig `json:"config,omitempty" orm:"type(jsonb)" example:"{\"host\":\"localhost\",\"port\":5432}"`
}
...
type DestinationTestConnectionRequest struct {
	...
	Version       string     `json:"version" binding:"required" example:"v0.2.7"`
	Config        JSONConfig `json:"config" binding:"required" example:"{\"catalog_type\":\"glue\",\"warehouse\":\"s3://my-bucket/warehouse\"}"`
...
type UpdateSourceRequest struct {
	...
	Type    string     `json:"type" binding:"required" example:"postgres"`
	Version string     `json:"version" binding:"required" example:"v0.2.7"`
	Config  JSONConfig `json:"config" orm:"type(jsonb)" binding:"required" example:"{\"host\":\"localhost\",\"port\":5432,\"database\":\"mydb\",\"user\":\"postgres\",\"password\":\"newsecret\"}"`
}
...
type CreateDestinationRequest struct {
	...
	Type    string     `json:"type" binding:"required" example:"iceberg"`
	Version string     `json:"version" binding:"required" example:"v0.2.7"`
	Config  JSONConfig `json:"config" orm:"type(jsonb)" binding:"required" example:"{\"catalog_type\":\"glue\",\"warehouse\":\"s3://my-bucket/warehouse\"}"`
}
...
type UpdateDestinationRequest struct {
	...
	Type    string     `json:"type" binding:"required" example:"iceberg"`
	Version string     `json:"version" binding:"required" example:"v0.2.7"`
	Config  JSONConfig `json:"config" orm:"type(jsonb)" binding:"required" example:"{\"catalog_type\":\"glue\",\"warehouse\":\"s3://my-bucket/warehouse-v2\"}"`
}
